...
//                            echo "SQL statement failed";
//                        }else{
//                            mysqli_stmt_bind_param("ssss", $imageTitle, $imageDesc, $imageFullName, $setImageOrder);
//                            mysqli_stmt_execute($stmt);
            ...
            if ($fileSize < 3000000) {
                ...
                if (empty($imageTitle) || empty($imageDesc)) {
                    ...
                    if (!mysqli_stmt_prepare($stmt, $sql)) {
                        ...
                        $sql = "INSERT INTO mygallery(titleGallery,descGallery,imgFullNameGallery,orderGallery) values (?,?,?,?);";
                        if (!mysqli_stmt_prepare($stmt, $sql)) {
